...
//! 将以下路径改成你的位置
string notlabelPath = "F:/data/easypr-data/notlabel";
string hasPaltePath = "F:/data/easypr-data/learn/hasPlate/";
string noPlatePath = "F:/data/easypr-data/learn/noPlate/";
